        ...
        internal:
            ...
            static System::Drawing::Bitmap^ GetBitmap(IAIMPImage* image)
            {
                ...
                if (CheckResult(image->GetSize(&size)))
                {
                    ...
                    if (stream->GetSize() > 0)
                    {
                        ...
                        r = stream->Read(buf, static_cast<unsigned int>(size));
            ...
            static IAIMPImage *CreateImage(System::Drawing::Bitmap ^image)
            {
                ...
                try
                {
                    ...
                    array<Byte> ^buffer = gcnew array<byte>(static_cast<int>(stream->Length));
                        ...
                        && CheckResult(ManagedAimpCore::GetAimpCore()->CreateObject(IID_IAIMPImage, (void**)&img)))
                    {
                        ...
                        unsigned char* pby = p;
                        if (CheckResult(aimpStream->Write(pby, static_cast<unsigned int>(stream->Length), nullptr)))
                        {
            ...
            static IAIMPImageContainer *ToContainer(System::Drawing::Bitmap ^image)
            {
                ...
                if (CheckResult(ManagedAimpCore::GetAimpCore()->CreateObject(IID_IAIMPImageContainer, (void**)&container)))
                {
                    ...
                    try
                    {
                        ...
                        if (Utils::CheckResult(container->SetDataSize(static_cast<int>(stream->Length))) != AIMP::SDK::AimpActionResult::Ok)
                        {
                            return NULL;
                        }
