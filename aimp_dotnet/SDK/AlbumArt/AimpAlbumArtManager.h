    ...
    namespace SDK
    {
        ...
        public:
                ...
                void set(array<System::String^>^ val)
                {
                    ...
                    try
                    {
                        if (GetService(IID_IAIMPServiceAlbumArt, &service) == AimpActionResult::Ok)
                        {
                            ...
                            IAIMPString *s = AimpConverter::MakeAimpString(_core->GetAimpCore(), str);
            ...
            virtual IntPtr GetImage(String^ fileUrl, String^ artist, String^ album, AimpFingCovertArtType flags, Object^ userData)
            {
                ...
                IAIMPString *sFileUrl = AimpConverter::MakeAimpString(_core->GetAimpCore(), fileUrl);
                IAIMPString *sArtist = AimpConverter::MakeAimpString(_core->GetAimpCore(), artist);
                IAIMPString *sAlbum = AimpConverter::MakeAimpString(_core->GetAimpCore(), album);
