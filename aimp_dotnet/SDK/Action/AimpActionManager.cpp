...
namespace AIMP
{
	namespace SDK
	{
		...
		void AimpActionManager::RegisterAction(AimpActionItem ^menuItem)
		{
			...
			IAIMPString* actionIdString = AimpConverter::MakeAimpString(_core->GetAimpCore(), menuItem->Id);
			IAIMPString* actionNameString = AimpConverter::MakeAimpString(_core->GetAimpCore(), menuItem->Text);
			IAIMPString* actionGroupString = AimpConverter::MakeAimpString(_core->GetAimpCore(), menuItem->GroupName);
