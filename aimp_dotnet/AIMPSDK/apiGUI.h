...
/*----------------------------------------------------------------------------------------------------------------------*/
  ...
  const int AIMPUI_EDIT_PROPID_CHANGEDELAY     = AIMPUI_BUTTONEDEDIT_MAX_PROPID + 1;
...
/*----------------------------------------------------------------------------------------------------------------------*/
  ...
  class IAIMPUIProgressBar: public IAIMPUIWinControl
  {
  };
  ...
  class IAIMPUITreeList: public IAIMPUIWinControl
  {
	  public:
			...
			// Grouping
			virtual HRESULT WINAPI GroupBy(IAIMPUITreeListColumn* Column, BOOL ResetPrevSortingParams) = 0;
