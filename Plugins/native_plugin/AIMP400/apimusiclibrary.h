...
const static WCHAR* AIMPML_RESERVED_FIELD_ID       = L"ID";       // !REQUIRED! unique record id (Int32, Int64 or String)
const static WCHAR* AIMPML_RESERVED_FIELD_FILENAME = L"FileName"; // !REQUIRED! string
const static WCHAR* AIMPML_RESERVED_FIELD_FILESIZE = L"FileSize"; // Int64, in bytes
const static WCHAR* AIMPML_RESERVED_FIELD_DURATION = L"Duration"; // double, in seconds
const static WCHAR* AIMPML_RESERVED_FIELD_USERMARK = L"UserMark"; // double, 0.0 .. 5.0
