...
static const GUID IID_IAIMPExtensionAlbumArtCatalog = {
    0x41494D50, 0x4578, 0x7441, 0x6C, 0x62, 0x41, 0x72, 0x74, 0x43, 0x61, 0x74
};
static const GUID IID_IAIMPExtensionAlbumArtCatalog2 = {
    0x41494D50, 0x4578, 0x416C, 0x62, 0x41, 0x72, 0x74, 0x43, 0x61, 0x74, 0x32
};
static const GUID IID_IAIMPExtensionAlbumArtProvider = {
    0x41494D50, 0x4578, 0x7441, 0x6C, 0x62, 0x41, 0x72, 0x74, 0x50, 0x72, 0x76
};
static const GUID IID_IAIMPExtensionAlbumArtProvider2 = {
    0x41494D50, 0x4578, 0x416C, 0x62, 0x41, 0x72, 0x74, 0x50, 0x72, 0x76, 0x32
};
static const GUID IID_IAIMPServiceAlbumArt = {
    0x41494D50, 0x5372, 0x7641, 0x6C, 0x62, 0x41, 0x72, 0x74, 0x00, 0x00, 0x00
};
static const GUID IID_IAIMPServiceAlbumArtCache = {
    0x4941494D, 0x5053, 0x7276, 0x41, 0x6C, 0x62, 0x41, 0x72, 0x74, 0x43, 0x68
};
...
typedef void (CALLBACK TAIMPServiceAlbumArtReceiveProc)(IAIMPImage* image, IAIMPImageContainer* imageContainer,
                                                        void* UserData);
...
public:
    ...
    virtual HRESULT WINAPI Get2(IAIMPFileInfo* FileInfo, DWORD Flags, TAIMPServiceAlbumArtReceiveProc* CallbackProc,
                                void* UserData, void** TaskID) = 0;
