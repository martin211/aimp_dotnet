...
bool AimpAlbumArtSearchOptions::FindInFiles::get() {
    int val = 0;
    _properties->GetValueAsInt32(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_FILES, &val);
    return val != 0;
}

void AimpAlbumArtSearchOptions::FindInFiles::set(bool value) {
    _properties->SetValueAsInt32(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_FILES, value ? 1 : 0);
}

bool AimpAlbumArtSearchOptions::FindInInternet::get() {
    int val = 0;
    _properties->GetValueAsInt32(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_INTERNET, &val);
    return val != 0;
}

void AimpAlbumArtSearchOptions::FindInInternet::set(bool value) {
    _properties->SetValueAsInt32(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_INTERNET, value ? 1 : 0);
}

array<String^>^ AimpAlbumArtSearchOptions::FileMasks::get() {
    IAIMPString* str;
    _properties->GetValueAsObject(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_FILES_MASKS, IID_IAIMPString,
...
void AimpAlbumArtSearchOptions::FileMasks::set(array<String^>^ value) {
    ...
    _properties->SetValueAsObject(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_FILES_MASKS, AimpConverter::ToAimpString(str));
}

array<String^>^ AimpAlbumArtSearchOptions::FileExtensions::get() {
    IAIMPString* str;
    _properties->GetValueAsObject(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_FILES_EXTS, IID_IAIMPString,
                                  reinterpret_cast<void**>(&str));
...
void AimpAlbumArtSearchOptions::FileExtensions::set(array<String^>^ value) {
    ...
    _properties->SetValueAsObject(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_FILES_EXTS, s);
    s->Release();
    s = nullptr;
}
...
int AimpAlbumArtSearchOptions::MaxFileSize::get() {
    int val = 0;
    _properties->GetValueAsInt32(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_INTERNET_MAX_FILE_SIZE, &val);
    return val;
}

void AimpAlbumArtSearchOptions::MaxFileSize::set(int value) {
    _properties->SetValueAsInt32(AIMP_ALBUMART_REQUEST_PROPID_FIND_IN_INTERNET_MAX_FILE_SIZE, value);
}
