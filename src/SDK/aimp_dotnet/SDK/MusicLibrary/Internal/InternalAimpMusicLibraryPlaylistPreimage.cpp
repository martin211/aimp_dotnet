...
// InternalAimpMusicLibraryPlaylistPreimage::InternalAimpMusicLibraryPlaylistPreimage(gcroot<IAimpMusicLibraryPlaylistPreimage^> managedInstance):
//     InternalAimpPlaylistPreimage(managedInstance) {
//     _managedInstance = managedInstance;
// }

InternalAimpMusicLibraryPlaylistPreimage::InternalAimpMusicLibraryPlaylistPreimage(
    gcroot<IAimpMusicLibraryPlaylistPreimage^> managedInstance): InternalAimpPlaylistPreimage(nullptr) {
}
