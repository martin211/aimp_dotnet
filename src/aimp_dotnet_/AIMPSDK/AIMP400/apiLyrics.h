...
static const GUID IID_IAIMPExtensionLyricsProvider = {
    0x41494D50, 0x4578, 0x744C, 0x79, 0x72, 0x69, 0x78, 0x50, 0x72, 0x76, 0x00
};
...
{
public:
    virtual HRESULT WINAPI Get(IAIMPFileInfo* FileInfo, DWORD Flags, TAIMPServiceLyricsReceiveProc* CallbackProc,
