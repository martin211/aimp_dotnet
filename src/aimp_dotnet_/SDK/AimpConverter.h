...
namespace AIMP
{
    namespace SDK
    {
        ...
        internal:
            ...
            static IAIMPImage* ToAimpImage(IAimpImage^ image);

            static AIMP::SDK::Visuals::AimpVisualData^ PAIMPVisualDataToManaged(PAIMPVisualData data);

            static IAimpImage^ ToManagedBitmap(IAIMPImageContainer* imageContainer);

            static IAimpImage^ ToManagedBitmap(IAIMPImage* image);

            static IAIMPImageContainer* ToAimpImageContainer(IAimpImage^ image);
