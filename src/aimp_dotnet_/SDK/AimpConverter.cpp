...
IAIMPImage* AimpConverter::ToAimpImage(IAimpImage^ image)
{
...
IAimpImage^ AimpConverter::ToManagedBitmap(IAIMPImageContainer* imageContainer)
{
...
IAimpImage^ AimpConverter::ToManagedBitmap(IAIMPImage* image)
{
    /*SIZE size;
...
IAIMPImageContainer* AimpConverter::ToAimpImageContainer(IAimpImage^ image)
{
