...
namespace AIMP.SDK.MusicLibrary.DataStorage
{
    ...
    public interface IAimpDataProvider
    {
        ...
        /// </param>
        /// <param name="filter">
        ///     Plugin must take it into account, if the <see cref="CapabilitiesType.Filtering" /> flag is defined
        ///     in the <see cref="AIMP.SDK.MusicLibrary.Extension.IAimpExtensionDataStorage.Capabilities" /> property value.
        /// </param>
