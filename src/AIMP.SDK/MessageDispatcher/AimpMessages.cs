...
namespace AIMP.SDK.MessageDispatcher
{
    ...
    public enum AimpCoreMessageType
    {
        ...
        ///     <note>
        ///         <li>Param1: Command ID. See the "Commands" charter.</li><li>Param2 - Not used.</li>
        ///     </note>
        /// </summary>
        ...
        ///     <note>
        ///         <li>Param1 - Not used.</li><li>Param2 - Not used.</li>
        ///     </note>
        /// </summary>
        ...
        ///     <note>
        ///         <li>Param1: 0 - Stopped, 1 - Paused, 2 - Playing.</li><li>Param2: Not used.</li>
        ///     </note>
        /// </summary>
        ...
        ///     <note>
        ///         <li>Param1: Property ID.</li><li>Param2: This parameter is same to Param2 for specified property.</li>
        ///     </note>
        /// </summary>
        ...
        ///     <note>
        ///         <li>Param1: Not used</li><li>Param2: Pointer to WideChar array, can be = nil (ReadOnly!)</li>
        ///     </note>
        /// </summary>
        ...
        ///     <note>
        ///         <li>Param1: AIMP_MSG_PROPVALUE_GET. Read Only</li><li>Param2: Pointer to LongBool.</li>
        ///     </note>
        /// </summary>
