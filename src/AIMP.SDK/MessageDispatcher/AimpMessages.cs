...
namespace AIMP.SDK.MessageDispatcher
{
    ...
    public enum AimpCoreMessageType
    {
        ...
        /// <note><li>Param1: 0 - text will be automatically hidden (delay before hiding is 2 seconds), 1 - text will be hidden manually (you must send message with Param2 set to nil / null).</li><li>Param2: Showing text: pointer to first element of null-terminating widechar array Hiding text: nil / null (for Param set to 1 only)</li></note>
        /// </summary>
        ...
        /// <note><li>Param1: New mark (from 0 to 5)</li><li>Param2: File name - pointer to first element of null terminated widechar-array. If file name is nil / null or empty its mean that marks for all files have been changed.</li></note>
        /// </summary>
        EventFileMark = Constants.BaseEvent + 12,

        /// <summary>
        /// Event occurs when statistics has been changed.
        /// <note><li>Param1: Not used.</li><li>Param2: File name - pointer to first element of null-terminated widechar-array. If file name is nil / null or empty its mean that statistic for all files have been changed.</li></note>
        /// </summary>
        ...
        /// <summary>
        /// Balance.
        /// <note><li>Param1: Access direction: Read / Write (AIMP_MSG_PROPVALUE_GET / AIMP_MSG_PROPVALUE_SET)</li><li>Param2: Pointer to the 32-bit floating point variable (Single).
        /// Range: -1.0 .. +1.0
        /// Default: 0.0</li></note>
        /// </summary>
        ...
        /// <note><li>Param1: Access direction: Read / Write (AIMP_MSG_PROPVALUE_GET / AIMP_MSG_PROPVALUE_SET)</li><li>Param2: Pointer to the 32-bit floating point variable (Single).
        /// Range: 0.0 .. 1.0
        /// Default: 0.0 (switched off)</li></note>
        /// </summary>
        ...
        /// <note><li>Param1: Access direction: Read / Write (AIMP_MSG_PROPVALUE_GET / AIMP_MSG_PROPVALUE_SET)</li><li>Param2: Pointer to the 32-bit floating point variable (Single).
        /// Range: 1.0 .. 5.0
        /// Default: 1.0 (switched off)</li></note>
        /// </summary>
        ...
        /// <note><li>Param1: Access direction: Read / Write (AIMP_MSG_PROPVALUE_GET / AIMP_MSG_PROPVALUE_SET)</li><li>Param2: Pointer to the 32-bit floating point variable (Single).
        /// Range: -15.0 .. 15.0 dB
        /// Default: 0.0 dB</li></note>
        /// </summary>
        PropertyPreamp = Constants.MessagePropertyBase + 13,

        /// <summary>
        /// Equalizer state (switched on / off).
        /// <note><li>Param1: Access direction: Read / Write (AIMP_MSG_PROPVALUE_GET / AIMP_MSG_PROPVALUE_SET)</li><li>Param2: Pointer to the 32-bit logical variable (LongBool).
        /// Values: False / True
        /// Default: False</li></note>
        /// </summary>
        ...
        /// <note><li>Param1: AIMP_MSG_PROPVALUE_GET Read Only</li><li>Param2: Pointer to the 32-bit integer variable (Integer).
        /// 0 - Repeat is switched off
        /// 1 - Point "A" is defined
        /// 2 - Point "B" is defined, repeat is switched on</li></note>
        /// </summary>
        ...
        /// <note><li>Param1: One of following values:
        /// AIMP_MPH_MAINFORM
        /// AIMP_MPH_APPLICATION
        /// AIMP_MPH_TRAYCONTROL
        /// AIMP_MPH_PLAYLISTFORM
        /// AIMP_MPH_EQUALIZERFORM</li><li>Param2: Pointer to the HWND.</li></note>
        /// </summary>
        ...
        /// <note><li>Param1: Access direction: Read / Write (<see cref="AimpCoreMessageType.AIMP_MSG_PROPVALUE_GET" /> / <see cref="AimpCoreMessageType.AIMP_MSG_PROPVALUE_SET" />)</li><li>Param2: Pointer to the 32-bit integer variable (Integer).
