...
namespace AIMP
{
    ...
    private ref class AimpPlayer :
        ...
        public AIMP::SDK::Services::Player::IAimpPlayer
    {
    private:
        ...
        EventHandler<AIMP::SDK::Services::Player::StateChangedEventArgs^> ^_onStateChanged;
    ...
    public:
        ...
        virtual property IAimpPlaybackQueueService ^PlaybackQueueManager
        {
            IAimpPlaybackQueueService ^get()
            {
                ...
                if (_playbackQueueManager == nullptr)
                {
                    ...
                    ((ManagedAimpCore^)_managedAimpCore)->CheckUrl += gcnew AIMP::SDK::Services::Playback::AimpCheckUrl(this, &AIMP::AimpPlayer::OnCheckUrl);
                }
        ...
        virtual event EventHandler<AIMP::SDK::Services::Player::StateChangedEventArgs^>^ StateChanged
        {
            void add(EventHandler<AIMP::SDK::Services::Player::StateChangedEventArgs^>^ onAction)
            {
                if (this->_onStateChanged == nullptr)
                {
                    _onStateChanged = (EventHandler<AIMP::SDK::Services::Player::StateChangedEventArgs^>^)Delegate::Combine(_onStateChanged, onAction);
                }
            }
            void remove(EventHandler<AIMP::SDK::Services::Player::StateChangedEventArgs^>^ onAction)
            {
                bool tmp = this->_onStateChanged != nullptr;
                if (tmp)
                {
                    _onStateChanged = (EventHandler<AIMP::SDK::Services::Player::StateChangedEventArgs^>^)Delegate::Remove(_onStateChanged, onAction);
                }
            }
            void raise(Object ^sender, AIMP::SDK::Services::Player::StateChangedEventArgs^ state)
            {
                if (this->_onStateChanged != nullptr)
                {
    ...
    private:
        void OnCoreMessage(AimpMessages::AimpCoreMessageType param1, int param2)
        {
            ...
            {
                _state = this->State;
                StateChanged(this, gcnew AIMP::SDK::Services::Player::StateChangedEventArgs(_state));
            }
